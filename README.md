...
```javascript
import Uint8Array from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-uint8@v0.2.1-deno/mod.js';
```
...
import ctor from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-uint8@v0.2.1-deno/mod.js';
